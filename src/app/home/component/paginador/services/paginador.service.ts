...
export class PaginadorService {
  ...
  BASEURLREDEEM =
    'https://private-anon-7a37600fad-aerolabchallenge.apiary-mock.com/redeem';
  ...
  private priceSubject = new BehaviorSubject<number>(2000);
  public priceHeader$ = this.priceSubject.asObservable();

  updatePrice(priceHeader: number): void {
    this.priceSubject.next(priceHeader);
  }
